...
?>
	...
	$sql = mysqli_query($koneksi, "SELECT * FROM pemilik,kamar WHERE pemilik.id_pemilik = kamar.id_pemilik AND kamar.id_kamar='$id'");
...
<div class="img-big-wrap">
  ...
  <dd>
    <?php
                        $fasilitas = mysqli_query($koneksi, "SELECT * FROM fasilitas,fasilitaskos WHERE fasilitas.id_fasilitas = fasilitaskos.id_fasilitas AND fasilitaskos.id_kamar='$id'");
...
<p class="price-detail-wrap"> 
  ...
  <span>/<?php echo $data['tipeharga']; ?></span> 
</p> <!-- price-detail-wrap .// -->
