...
?>
	...
	$sqla = mysqli_query($koneksi, "SELECT * FROM pemilik,kamar WHERE pemilik.id_pemilik = kamar.id_pemilik AND pemilik.nama_kos LIKE '$id'");
	$dataa = mysqli_fetch_array($sqla);

  $idnya = $dataa['id_kamar'];

  $sql = mysqli_query($koneksi, "SELECT * FROM pemilik,kamar WHERE pemilik.id_pemilik = kamar.id_pemilik AND kamar.id_kamar='$idnya'");
...
<div class="img-big-wrap">
  ...
  <dd>
    <?php
                        $fasilitas = mysqli_query($koneksi, "SELECT * FROM fasilitas,fasilitaskos WHERE fasilitas.id_fasilitas = fasilitaskos.id_fasilitas AND fasilitaskos.id_kamar='$idnya'");
                        while ($r_fasilitas = mysqli_fetch_array($fasilitas)) {
...
<dl class="param param-feature">
  ...
  <dd>
    ...
    <p>
                        ...
                        <?php
                        $analisa = mysqli_query($koneksi, "SELECT * 
                                                FROM analisa
