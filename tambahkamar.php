                        ...
                        <div class="panel-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                          <div class="form-group">
                                            ...
                                            $tampil=mysqli_query($koneksi,"SELECT * FROM pemilik ORDER BY id_pemilik DESC");
                                          ...
                                          <div class="form-group">
                                            ...
                                            <ul class="fasilitas">
                                                ...
                                                while ($r_fasilitas = mysqli_fetch_array($q_fasilitas)) {
                                ...
                                <?php
                                      ...
                                      $data = mysqli_fetch_array(mysqli_query($koneksi,'SELECT id_kamar FROM kamar ORDER BY id_kamar DESC LIMIT 1'));

                                      foreach ($_POST['fasilitas'] as $fasilitas) {
                                          mysqli_query($koneksi, 'INSERT INTO fasilitaskos(id_kamar,id_fasilitas) VALUES(' . $data['id_kamar'] . ',' . $fasilitas . ')');
                                      }
